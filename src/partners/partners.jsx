...
const Partners = () => (
    <div className="main">
        ...
        <div className="partnerstop"></div>
        <div className="partnersbot">
            <span className="partnerstext1">
                <Partcomp text="Предлагаем высокооплачиваемую удаленную работу!
                            ...
                            приглашений и страховок будет варьироваться от 200 до 400 гривен
            ...
            <Partcomp text= "Будем рады сотрудничеству!"/></div>
    </div>
) 
